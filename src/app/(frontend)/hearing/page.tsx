...
export const questions: Question[] = [
  ...
  { id: 'q10', cat: 'Category 4', title: 'サイトに必要な機能は？', desc: '※複数選択可', type: 'checkbox', options: [{ label: 'ブログ', value: 'ブログ' }, { label: 'フォーム', value: 'フォーム' }, { label: '予約システム', value: '予約システム' }, { label: 'EC決済', value: 'EC決済' }, { label: '会員ページ', value: '会員ページ' }, { label: '動画埋め込み', value: '動画埋め込み' }, { label: 'SNS連携', value: 'SNS連携' }, { label: '多言語', value: '多言語' }, { label: 'なし・不明', value: 'なし・不明' }] },

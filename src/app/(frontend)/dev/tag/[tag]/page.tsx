...
export default async function DevTagPage({
    ...
    // Fetch published tech-posts and filter by tag in-memory
            ...
            <main className="grow px-4 sm:px-6 lg:px-40 pt-14 pb-16 md:pt-28 md:pb-32 relative z-10">
                <div className="max-w-[960px] mx-auto flex flex-col gap-10 mt-2 md:mt-8">
                    ...
                    <div className="flex flex-col gap-4 mb-4">
                        <Link href="/dev" className="text-slate-500 hover:text-(--color-neu-primary) transition-colors flex items-center gap-2 text-sm font-bold">
                    ...
                    {mappedPosts.length === 0 ? (
                        ...
                        <BlogRecentStoriesClient recentPosts={mappedPosts} basePath="/dev" />
                    )}
                </div>
            </main>
